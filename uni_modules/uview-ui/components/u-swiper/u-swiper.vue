...
<script>
	 ...
	 * @property {String | Number}	current					当前所在滑块的 uview（默认 0 ）
	 ...
	 * @event {Function(uview)}	click	点击轮播图时触发	uview：点击了第几张图片，从0开始
	 * @event {Function(uview)}	change	轮播图切换时触发(自动或者手动切换)	uview：切换到了第几张图片，从0开始
